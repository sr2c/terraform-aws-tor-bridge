...
| <a name="requirement_openstack"></a> [openstack](#requirement\_openstack) | ~> 4.2.0 |
...
| <a name="input_availability_zone"></a> [availability\_zone](#input\_availability\_zone) | Availability zone to deploy the instance in. | `string` | `"us-east-1a"` | no |
| <a name="input_blueprint"></a> [blueprint](#input\_blueprint) | Blueprint ID to use for the compute instance (must be Debian 11 based). | `string` | `"Debian 11"` | no |
| <a name="input_bundle_id"></a> [bundle\_id](#input\_bundle\_id) | Bundle ID to use for the Lightsail instance. | `string` | `"micro_2_0"` | no |
